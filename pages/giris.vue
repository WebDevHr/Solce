    ...
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-20 lg:px-8">
        ...
        <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-3" action="#" method="POST">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="#" class="font-semibold text-orange-600 hover:text-indigo-500">Şifrenizi mi
                                unuttunuz?</a>
                        </div>
                    </div>
                    <div class="mt-2">
                ...
                <div class="pt-5">
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-orange-600 px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">Giriş
                        Yap</button>
                </div>
            </form>
            ...
            <p class="mt-5 text-center text-sm text-gray-500">
                Üye Değil Misiniz?
                {{ ' ' }}
                <nuxt-link to="/uyeol" class="font-semibold leading-6 text-orange-600 hover:text-orange-500">Üye
                    Olun</nuxt-link>
            </p>
        </div>
    </div>
